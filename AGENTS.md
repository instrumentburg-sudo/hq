...
В футере — 4 ссылки: полный реестр проектов (§6), оркестра OpenClaw (§11), курс Personal Corp — последний урок (`course/lesson{N}.html`, сейчас `lesson2.html`), репозиторий на GitHub.
