...
| Проект | Путь | Стек | Приор. | Статус | Коммит |
|---|---|---|:-:|:-:|:-:|
| [personal-corp](#personal-corp) | `/home/iamsohappy/projects/Githab/personal corp` | HTML, JSON, транскрипты | P2 | active | 2026-05-04 |
...
**Контекст.** Уроки курса + извлечённые материалы. Урок 01 — HQ и агент-оркестрация; урок 02 — масштабирование без оверинженеринга (слои стратегии/исполнения, скиллы, Human Gate, Claude+Codex); урок 03 — от штаба к рабочей среде (парсинг данных в контекст, CRM на md-карточках, Codex Automation как cron, Meeting Copilot для живых созвонов). Публичные копии выжимок в `hq/course/lesson{N}.html`.
