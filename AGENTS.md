...
**Контекст.** Уроки курса + извлечённые материалы. Первый урок — про HQ и агент-оркестрацию. Публичная копия выжимки в `hq/course/lesson1.html`.
...
- KPI-strip: общее число проектов, активных, P1-ядра, дата обновления.
- Chronicle: 4–6 последних событий по P1-проектам (дата · проект · короткое описание).
- Ядро P1: 10 карточек (4 hero, 6 compact) с recency-heat (5-dot шкала по давности коммита).
- Agent Mesh: 10 ролей OpenClaw (имя и зона ответственности, без @handle).
- Полный реестр: 30 проектов, 8 групп; каждая строка — приоритет, статус-дот, название, стек, дата коммита.
- Активные длинные задачи: название, проект, приоритет, статус.
- Активные короткие задачи: название, проект, статус.
- Personal Corp — прогресс уроков.
